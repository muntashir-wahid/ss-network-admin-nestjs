...
export type ClientWhereInput = {
  ...
  uid?: Prisma.StringFilter<"Client"> | string
  ...
  addressLine?: Prisma.StringFilter<"Client"> | string
...
export type ClientScalarWhereWithAggregatesInput = {
  ...
  uid?: Prisma.StringWithAggregatesFilter<"Client"> | string
  ...
  addressLine?: Prisma.StringWithAggregatesFilter<"Client"> | string
...
export type ClientUpdateInput = {
  ...
  zone?: Prisma.ZoneUpdateOneRequiredWithoutClientsNestedInput
}
...
export interface ClientDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `uid`
   * const clientWithUidOnly = await prisma.client.findMany({ select: { uid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Clients and only return the `uid`
   * const clientWithUidOnly = await prisma.client.createManyAndReturn({
   *   select: { uid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Clients and only return the `uid`
   * const clientWithUidOnly = await prisma.client.updateManyAndReturn({
   *   select: { uid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ClientFieldRefs {
  readonly uid: Prisma.FieldRef<"Client", 'String'>
  ...
  readonly addressLine: Prisma.FieldRef<"Client", 'String'>
